...
router.post("/create", function (req, res) {
    ...
    const {first_name,last_name,birthday,gender,staff_tel,staff_email,province_id_fk,district_id_fk,village_name,staff_remark,register_date} = req.body;
    const table = 'tbl_staff';
    db.autoId(table, 'id', (err, id) => {
    const id_code='VK-'+id;
    const fields = 'id,staff_uuid, id_code,gender,first_name,last_name,birthday,staff_tel,staff_email,province_id_fk,district_id_fk,village_name,staff_remark,register_date,status_inout,create_date';
    const dataValue = [id,staff_uuid,id_code,gender, first_name,last_name,birthday,staff_tel,staff_email,province_id_fk,district_id_fk,village_name,staff_remark,register_date,'1',dateTime];
...
router.post("/edit", function (req, res) {
    const {staff_uuid,first_name,last_name,birthday,gender,staff_tel,staff_email,province_id_fk,district_id_fk,village_name,staff_remark,register_date} = req.body;
    const table = 'tbl_staff';
    const field = 'gender,first_name,last_name,birthday,staff_tel,staff_email,province_id_fk,district_id_fk,village_name,staff_remark,register_date';
    const newData = [gender,first_name,last_name,birthday,staff_tel,staff_email,province_id_fk,district_id_fk,village_name,staff_remark,register_date,staff_uuid]; 
