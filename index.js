...
const usePayment = require('./api/data/api-payment')
...
const usePycenter = require('./api/website/api-pycenter');
const useBank = require('./api/setting/api-bank');
//===================== use router
...
app.use('/pcenter', usePycenter);
app.use('/bank', useBank);
