...
const field = 'branch_name,branch_tel,branch_email,branch_logo,province_id_fk,district_id_fk,village_name,branch_detail,branch_status,statusUse';
const upload = multer({ storage }).single('file');
upload(req, res, function (err) {
const {branch_uuid,branch_name,branch_tel,branch_email,province_id_fk,district_id_fk,village_name,branch_detail,branch_status,statusUse}=req.body;
// if(branch_uuid ===''){

	const newData = [branch_name, branch_tel, branch_email,nyLogo, province_id_fk,district_id_fk,village_name,branch_detail,branch_status,statusUse, branch_uuid];
